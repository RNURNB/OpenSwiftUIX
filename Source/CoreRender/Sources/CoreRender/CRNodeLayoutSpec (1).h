...
//@property(nonatomic) NSString * properties2;
...
@interface LayoutSpecWrapper<__covariant V : UIView *> : NSObject

- (instancetype)init;

@property(nonatomic, readonly, nullable) void (^layoutSpec)(CRNodeLayoutSpec<V> *);

- (void) add:(void (^)(CRNodeLayoutSpec<V> *)) spec;
